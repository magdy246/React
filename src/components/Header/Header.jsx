  ...
  return (
    <>
      <nav
        className={
          navbar
            ? 'bg-white fixed top-0 right-0 left-0 border-gray-200 main_color z-30 navbar move'
            : 'bg-white fixed top-0 right-0 left-0 border-gray-200 main_color z-30 navbar py-3'
        }
      >
